...
class AlgorandBlockchain {
  ...
  async sendTransaction(transaction, hotWallet) {
    ...
    try {
      ...
      const actionType =
        txn.type === 'pay'
          ? chainjs.ModelsAlgorand.AlgorandChainActionType.Payment
          : txn.type === 'axfer'
          ? chainjs.ModelsAlgorand.AlgorandChainActionType.AssetTransfer
          : txn.type === 'appl'
          ? chainjs.ModelsAlgorand.AlgorandChainActionType.AppNoOp
          : null
